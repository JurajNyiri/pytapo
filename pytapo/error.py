...
class DayNightModeNotSupportedException(TapoException):
    """Exception for when the requested day night mode is not supported by the Tapo device."""

    def __init__(
        self, message="Requested day night mode is not supported by the Tapo device"
    ):
        super().__init__(message)


class DetectionSensitivityNotSupportedException(TapoException):
    """Exception for when the requested detection sensitivity is not supported by the Tapo device."""

    def __init__(
        self,
        message="Requested detection sensitivity is not supported by the Tapo device",
    ):
        super().__init__(message)


class DetectionException(TapoException):
    """Exception for when the requested detection is not supported by the Tapo device."""

    def __init__(
        self,
        message="Requested detection is not supported by the Tapo device",
    ):
        super().__init__(message)


class RecordingNotSupportedException(TapoException):
    """Exception for when the requested recording is not supported by the Tapo device."""

    def __init__(
        self,
        message="Requested recording is not supported by the Tapo device",
    ):
        super().__init__(message)


class LightFrequencyModeNotSupportedException(TapoException):
    """Exception for when the requested light frequency mode is not supported by the Tapo device."""

    def __init__(
        self,
        message="Requested light frequency mode is not supported by the Tapo device",
    ):
        super().__init__(message)


class AuthInvalidException(TapoException):
    """Exception for when the requested light frequency mode is not supported by the Tapo device."""
...
class AlarmException(TapoException):
    """Exception for when the requested light frequency mode is not supported by the Tapo device."""

    def __init__(
        self,
        message="Alarm exception",
    ):
        super().__init__(message)

class MotorException(TapoException):
    """Exception for when the requested light frequency mode is not supported by the Tapo device."""

    def __init__(
        self,
        message="Motor exception",
    ):
        super().__init__(message)


class ResponseException(TapoException):
    """Exception for when the requested light frequency mode is not supported by the Tapo device."""

    class SettingsException(TapoException):
        """Exception for when the requested light frequency mode is not supported by the Tapo device."""

        def __init__(
            self,
            message="Settings exception",
        ):
            super().__init__(message)
...
class HttpStatusCodeException(TapoException):
    def __init__(self, status_code):
        self.status_code = status_code
        self.message = f"HTTP request returned {self.status_code} status code"
